...
/**
 * Apply NN Classifier on output of ICA 
 *
 * @version 1.0
 */
public class NNWithIndependentComponentAnalysisTest {
    ...
    public static void main(String[] args) {
    	try {
            ...
            PrincipalComponentAnalysis filter = new PrincipalComponentAnalysis(set, 15);
            filter.filter(set);
