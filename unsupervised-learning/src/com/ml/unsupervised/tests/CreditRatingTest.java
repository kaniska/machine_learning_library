 ...
 * find optimal weights to a neural network that is classifying Credit Rating. 
 *
 * @author kmanda1
 * @version 1.0
 */
public class CreditRatingTest {
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < oa.length; i++) {
            ...
            for(int j = 0; j < instances.length; j++) {
            	if(instances[j] == null || instances[j].getData() == null) continue;
    ...
    private static Instance[] initializeInstances() {
        ...
        try {
            BufferedReader br = new BufferedReader(new FileReader(new File("resources/CreditRating-train.txt")));
